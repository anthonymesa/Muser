...
public:
    ...
    void RenderToAudio(const char *filename);
...
private:
    ...
    boolean ElementHasValue(const int &row, const int &sample_index);
};
...
//====================================================
void Muse::RenderToAudio(const char *filename)
{
    AudioFile<double> audioFile;
    AudioFile<double>::AudioBuffer buffer;
    int numChannels = 1;
    int numSamplesPerChannel = 48000;
...
//====================================================
boolean Muse::ElementHasValue(const int &row, const int &sample_index)
{
